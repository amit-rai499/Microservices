...
public class S3Service implements FileService {
	...
	public static final String BUCKET_NAME = "metube-youtube-clone";
	...
	public String uploadFile(MultipartFile file) {
		...
		try {
			...
			throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "An exception ocurred while uploading video");
